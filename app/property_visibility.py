...
def product_visible_property_condition():
    ...
    and represents a usable source listing. Internal synthetic crawler identities are never
    product-facing even if an older payload accidentally marked them accepted.
