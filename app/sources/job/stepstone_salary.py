...
class StepStoneAtJobSource(SearchCardStepStoneAtJobSource):
    """StepStone frontier with salary detail enrichment for accepted vacancies."""
    ...
    async def fetch_shard(
        ...
        *,
        ...
        selected = (
            candidates[: self.max_details_per_shard]
            if self.max_details_per_shard is not None
            else candidates
        )
        ...
        diagnostics.update(
            {
                ...
                "salary_detail_limit": self.max_details_per_shard,
