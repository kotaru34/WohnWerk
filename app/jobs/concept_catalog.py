...
EXTRACTOR_VERSION = "concept-seed-2026-08-28-v1"
...
CONCEPT_SEEDS: tuple[ConceptSeed, ...] = (
    ...
    ConceptSeed(
        ...
        ("Servicetechniker", "Service Engineer", "Field Service Engineer"),
    ),
    ConceptSeed(
        ConceptKind.ROLE,
        "cad-designer",
    ...
    ConceptSeed(
        ...
        ("Projektsteuerung", "Technical Project Management", "Projektkoordination"),
    ),
    ConceptSeed(
        ConceptKind.TASK,
        "team-leadership",
